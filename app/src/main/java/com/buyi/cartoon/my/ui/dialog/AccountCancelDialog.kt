package com.buyi.cartoon.my.ui.dialog

import android.os.Bundle
import android.view.LayoutInflater
import android.view.View
import android.view.ViewGroup
import com.buyi.cartoon.databinding.AccountCancelDialogLayoutBinding
import com.buyi.cartoon.databinding.PrimaryConfirmDialogLayoutBinding
import com.buyi.cartoon.main.base.BaseDialog

class AccountCancelDialog : BaseDialog<AccountCancelDialogLayoutBinding>() {
    ...
    override fun getViewBinding(
            ...
            container: ViewGroup?
    ): AccountCancelDialogLayoutBinding {
        return AccountCancelDialogLayoutBinding.inflate(inflater, container, false)
    }
